...
def normalize_team_name(name: str) -> str:
    """Normalize common team name variations to a canonical form."""
    if not name:
        return ""
...
class TeamRatings:
    ...
    def update_ratings_after_match(self, home_team: str, away_team: str,
        ...
        home_rating = self.get_rating(home_team_n)
        away_rating = self.get_rating(away_team_n)
        ...
        self.update_rating(home_team_n, new_home_rating)
        self.update_rating(away_team_n, new_away_rating)
